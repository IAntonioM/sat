...
@section('content')
    <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
        ...
        <div class="card-body p-9">
            ...
            <!--begin::Input group-->
            <div class="row mb-7">
                <label class="col-lg-4 fw-semibold text-muted">Códigos contribuyente</label>
                <div class="col-lg-8">
                    @foreach ($listarCuentas as $cuenta)
                        <i class="fa-solid fa-circle-check"></i>
                        <a href="{{ route('SeleccionarPerfil', ['codigo' => trim($cuenta->vcodcontr)]) }}"
                            class="fw-semibold fs-6 text-gray-800 text-hover-primary" style="padding: 1rem 0rem;">
                            {{ trim($cuenta->vcodcontr) }}
                        </a><br>
                        <div class="separator separator-dashed my-6"></div>
                    @endforeach
                </div>
