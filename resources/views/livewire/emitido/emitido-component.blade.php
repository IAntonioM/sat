...
<div class="card-body">
    ...
    <div class="d-flex flex-wrap gap-2 justify-content-between mb-8">
        ...
        <div class="d-flex">
            <!--begin::Sort-->
            <a href="#" class="btn btn-sm btn-icon btn-light btn-active-light-primary me-2" data-bs-toggle="tooltip"
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="pe-5">
                    ...
                    <div class="d-flex align-items-center flex-wrap gap-1">
                        <a href="#" class="fw-bold text-dark text-hover-primary">{{ $padre->nombre_emisor ?? 'Nombres Emisor no Disponible' }}</a>
                    ...
                    <div class="text-muted fw-semibold mw-450px d-none" data-kt-inbox-message="preview">With resrpect, i
        ...
        <div class="d-flex flex-wrap gap-2 flex-stack cursor-pointer" data-kt-inbox-message="header">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="pe-5">
                    ...
                    <!--end::Message details-->
                    <!--begin::Preview message-->
                    <div class="text-muted fw-semibold mw-450px" data-kt-inbox-message="preview">Jornalists call this
