...
class ConsolidadoReport extends FPDF
{
    ...
    public function __construct($codigoContribuyente, $anioSeleccionado = '%', $tipoTributo = '%')
    {
        ...
        $this->datosContribuyente = DeudaConsolidada::obtenerDatosContribuyente($this->codigoContribuyente);
        ...
        $this->deudas = DeudaConsolidada::obtenerDeudasDetalladas(
    ...
    public function Header()
    {
        ...
        $this->Cell(0, 4, "REPORTE DE DEUDAS CONSOLIDADAS", 0, 0, 'C');
        $this->Ln(8);
    ...
    private function organizarPorAnio($deudas)
    {
        ...
        foreach ($deudas as $deuda) {
            if (!isset($deudasPorAnio[$deuda->año])) {
                $deudasPorAnio[$deuda->año] = [];
            }
            $deudasPorAnio[$deuda->año][] = $deuda;
        }
    ...
    public function generarPDF()
    {
        ...
        foreach ($deudasPorAnio as $anio => $deudasAnio) {
            ...
            foreach ($deudasAnio as $deuda) {
                ...
                $this->Cell($w[1], 8, $deuda->año, 1, 0, 'C');
        ...
        return $this->Output('Reporte-Consolidado.pdf', 'I');
    }
}
